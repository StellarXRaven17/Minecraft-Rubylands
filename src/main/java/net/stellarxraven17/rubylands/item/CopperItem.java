...
public abstract class CopperItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 8, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(Items.COPPER_INGOT)), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("rd:copper"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("rd:copper"), armorMaterial);
