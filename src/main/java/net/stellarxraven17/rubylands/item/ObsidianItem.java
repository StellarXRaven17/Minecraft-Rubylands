...
public abstract class ObsidianItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 12, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(RdModItems.OBSIDIAN_INGOT.get())), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("rd:obsidian"))), 2.5f, 0f);
			registerHelper.register(ResourceLocation.parse("rd:obsidian"), armorMaterial);
