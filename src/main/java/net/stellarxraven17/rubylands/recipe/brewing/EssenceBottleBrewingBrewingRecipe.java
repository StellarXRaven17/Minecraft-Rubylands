...
@EventBusSubscriber
public class EssenceBottleBrewingBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new EssenceBottleBrewingBrewingRecipe());
	}
	...
	public boolean isIngredient(ItemStack ingredient) {
		return Ingredient.of(new ItemStack(RdModItems.ESSENCE.get())).test(ingredient);
	}
