...
import com.fauxjang.rubylands.init.*;

@Mod("rd")
public class RdMod {
	public static final Logger LOGGER = LogManager.getLogger(RdMod.class);
	public static final String MODID = "rd";

	public RdMod(IEventBus modEventBus) {
